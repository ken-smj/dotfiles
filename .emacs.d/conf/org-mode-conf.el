...
(setq org-capture-templates
	...
	("o" "with obstruction tag" entry (file+headline (concat org-directory "daily-journal.org") "残件タスク")
	 "** TODO %? :%^{redmine?}:obstruction:\n SCHEDULED: %^{Schedule?}T\n   %i\n  Entered on %U\n")
	("p" "project" entry (file+headline (concat org-directory "daily-journal.org") "残件タスク")
	 "** %? :%^{redmine?}:\n SCHEDULED: %^{Schedule?}T\n   %i\n  Entered on %U\n")
	("r" "Rest Log Item" entry (clock (concat org-directory "daily-journal.org")) "** %? :rest:\n  Entered on %U\n" :clock-in t :clock-resume t)
	("t" "todo task" entry (file+headline (concat org-directory "daily-journal.org") "残件タスク")
