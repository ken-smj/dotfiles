...
(defconst asciidoc-font-lock-keywords
  (eval-when-compile
    (list
     ...
     (cons "^\\.[A-Za-z0-9ƒ÷‹¸ˆ‰ﬂ].*$"`'asciidoc-paragraph-face)
     ...
     (cons "^\\s-*[a-zA-Zƒ÷‹¸ˆ‰ﬂ]\\.\\s-+" `'asciidoc-list-item-face)
     ...
     (cons "\\*[A-Zƒ÷‹¸ˆ‰ﬂ]+\\*:" `'asciidoc-paragraph-face)
     ...
     ;; Uppercase
     (cons "\\b[A-Zƒ÷‹ﬂ]+[A-Z‹÷ƒﬂ0-9\\- ]*\\b" `'asciidoc-upper-face)
