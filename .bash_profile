...
### PATH ###
############
export emacs_dir=${HOME}/local/emacs-25.2
...
export PATH=${PATH}:${emacs_dir}/bin:${HOME}/.emacs.d/libexec/w32:${HOME}/.emacs.d/libexec/w32/glo62Bwb/bin:${HOME}/AppData/Local/Pandoc:/c/Windows/System32
